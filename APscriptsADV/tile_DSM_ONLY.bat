...
rem
rem 2/26/2020 removing all code except that needed to create an unsmoothed DSM
rem
...
REM set the command line options for CanopyModel to produce DSM...no ground normalization and no outlier exclusion
SET CM_OPTIONS=/gridxy:%BUFFEREDEXTENT% %CLASSOPTION%

REM do canopy surface
IF /I [%DOCANOPY%]==[true] (
