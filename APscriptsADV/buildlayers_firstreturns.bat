...
rem we often only want the intensity metrics for the first returns...if so, remove the comment to jump to the intensity section
rem goto INTENSITY
...
rem skip returns 6+ (6-9 plus other, columns 44-48)
...
call "%PROCESSINGHOME%\extract_metric" _first_returns_elevation_stats 71 FIRST_RETURNS_profile_area_%FILEIDENTIFIER% %MULTIPLIER%
