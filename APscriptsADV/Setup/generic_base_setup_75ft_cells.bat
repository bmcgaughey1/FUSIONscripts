...
rem DO NOT USE THIS FILE AS A TEMPLATE FOR RUNS...
REM USES 75 FOOT CELLS
...
IF /I [%UNITS%]==[feet] (
	...
	SET MULTIPLIER=1.0
	SET TOPOCELLSIZE=75
	SET INTENSITYCELLSIZE=5
	SET INTENSITYCELLAREA=25
	set MULTITOPOWINDOWSIZES=37.5,112.5,337.5,675
	set MULTITPIWINDOWSIZES=375,750,1125,1500,6000
...
IF /I [%UNITS%]==[feet] (
	SET CANOPYCELLSIZE=3
	SET CANOPYCELLSIZE1=3.75
	SET CANOPYCELLSIZE2=5
	SET CANOPYSTATSCELLMULTIPLIER=25
) ELSE (
