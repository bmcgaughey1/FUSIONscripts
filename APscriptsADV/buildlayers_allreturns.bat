rem revisions:
rem 3/3/2016 added extraction of returns count layers for returns 6 & 7 
...
call "%PROCESSINGHOME%\extract_metric" _all_returns_elevation_stats 71 profile_area_%FILEIDENTIFIER% %MULTIPLIER%
