...
REM coordinate system  0=unknown, 1=UTM, 2=state plane
...
REM	SET MULTIPLIER=1.0
	SET MULTIPLIER=0.3048006
	SET TOPOCELLSIZE=65.616
...
IF /I [%UNITS%]==[feet] (
	...
	SET CANOPYSTATSCELLMULTIPLIER=20
) ELSE (
